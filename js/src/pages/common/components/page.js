module.exports = function(node, opts) {
    ...
    var render = require("pages/common/tmpl/page.ejs");
    ...
    var custFuncs = {
        pageChange: function() {
            ...
            //当前页码结束
            var curNum = maxPageSize != curpage ? 
             nodeList.pageSize.value * curpage : 
             ( nodeList.pageSize.value * (curpage - 1)+ opts.totalRows %  nodeList.pageSize.value);

            dataset.set(nodeList.text, "curNum", curNum);

            nodeList.text.innerHTML = "当前"+ (1 +  nodeList.pageSize.value * (curpage -1)) + "到" 
            + curNum
            +"条，总共"+ opts.totalRows+ "条";
