...
module.exports = function (node, opts) {
    ...
    var custFuncs = {
        pageChange: function () {
            ...
            nodeList.text.innerHTML = "当前" + ePage * opts.curPage + "到" + (opts.totalRows % ePage == 0 ? ePage * (opts.curPage + 1) : ePage * opts.curPage + opts.totalRows % ePage) + "条" + "条，总共" + opts.totalRows;
        },
        initView: function () {
