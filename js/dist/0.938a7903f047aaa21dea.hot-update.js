...
module.exports = function (node, opts) {
    ...
    var custFuncs = {
        pageChange: function () {
            ...
            nodeList.text.innerHTML = "当前" + nodeList.pageSize.value * (nodeList.page.value - 1) + "到" + (opts.totalRows % nodeList.pageSize.value == 0 ? nodeList.pageSize.value * nodeList.page.value : nodeList.pageSize.value * (nodeList.page.value - 1) + opts.totalRows % nodeList.pageSize.value) + "条，总共" + opts.totalRows + "条";
        },
        initView: function () {
