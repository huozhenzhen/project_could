...
module.exports = function (node, opts) {
    ...
    var dataset = !(function webpackMissingModule() { var e = new Error("Cannot find module \".\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())();
    ...
    var custFuncs = {
        pageChange: function () {
            ...
            nodeList.text.dataset.set();

            nodeList.text.innerHTML = "当前" + nodeList.pageSize.value * (nodeList.page.value - 1) + "到" + value1 + "条，总共" + opts.totalRows + "条";
        },
        initView: function () {
            custFuncs.pageChange();
        }
