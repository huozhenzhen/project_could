...
var getXMLHttpRequest = __webpack_require__(90);
...
module.exports = function (node, opts) {
    ...
    var render = __webpack_require__(87);
...
var base = __webpack_require__(4);
var parsePage = __webpack_require__(11);
var ajax = __webpack_require__(79);
var scss = __webpack_require__(66);
var when = __webpack_require__(36);
var moduleListData = __webpack_require__(78);
var pathManager = __webpack_require__(83);
var frames = __webpack_require__(82);
var dialogManager = __webpack_require__(38);
...
var custFuncs = {
	...
	updateView: function () {
		...
		if (moduleList == null) {
			...
			custFuncs.getModuleList().then(custFuncs.checkModule).then(custFuncs.initPage).then(custFuncs.openPage).otherwise(custFuncs.errorHandler);
		}
	},
