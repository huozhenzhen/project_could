...
module.exports = function (node, opts) {
    ...
    var custFuncs = {
        pageChange: function () {
            ...
            nodeList.total.innerHTML = page + "&nbsp;/&nbsp;" + Math.ceil(opts.totalRows / pageSize);
            nodeList.text.innerHTML = "当前" + pageSize * page + "到" + (opts.totalRows % pageSize == 0 ? pageSize * (page + 1) : pageSize * page + opts.totalRows % pageSize) + "条，总共" + opts.totalRows + "条";
        },
        initView: function () {
            custFuncs.pageChange();
        }
