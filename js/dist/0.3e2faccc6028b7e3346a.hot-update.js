...
module.exports = function (node, opts) {
    ...
    var custFuncs = {
        pageChange: function () {
            nodeList.total.innerHTML = opts.curPage + "&nbsp;/&nbsp;" + Math.ceil(opts.totalRows / nodeList.pageSize.value);
            nodeList.text.innerHTML = "当前" + nodeList.pageSize.value * opts.curPage + "到" + opts.totalRows % nodeList.pageSize.value;
        },
        initView: function () {
