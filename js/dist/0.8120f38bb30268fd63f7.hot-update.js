...
module.exports = function (node, opts) {
    ...
    var evtFuncs = {
        ...
        last: function () {
            if (custFuncs.isNext()) return;
            nodeList.page.value = Math.ceil(opts.totalRows / nodeList.pageSize.value);
            custFuncs.pageChange();
        },
        prev: function () {
    ...
    var custFuncs = {
        pageChange: function () {
            var curpage = nodeList.page.nodeList.total.innerHTML = curpage + "&nbsp;/&nbsp;" + Math.ceil(opts.totalRows / nodeList.pageSize.value);
            //当前页码结束
            var curNum = Math.ceil(opts.totalRows / nodeList.pageSize.value) != curpage ? nodeList.pageSize.value * curpage : nodeList.pageSize.value * (curpage - 1) + opts.totalRows % nodeList.pageSize.value;
