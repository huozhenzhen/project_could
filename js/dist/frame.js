 ...
 **/
var getType = __webpack_require__(1);
var jsonToQuery = __webpack_require__(64);
...
var getXMLHttpRequest = __webpack_require__(104);
var merge = __webpack_require__(4);
var jsonToQuery = __webpack_require__(64);
var appendQuery = __webpack_require__(65);
var console = __webpack_require__(3);
...
module.exports = function (node, opts) {
    ...
    var render = __webpack_require__(97);
    var nodeOpera = __webpack_require__(25);
    var appendQuery = __webpack_require__(65);
    var each = __webpack_require__(0);
    //-----------声明模块全局变量-------------
...
module.exports = function (node, opts) {
    ...
    var base = __webpack_require__(2); // 基础对象
    var parseModule = __webpack_require__(5); // 页面模块自动解析
    var proxy = __webpack_require__(61);
    var className = __webpack_require__(21);
    var sizzle = __webpack_require__(7);
...
module.exports = function (node, opts) {
    ...
    var leftNavRender = __webpack_require__(98); // 模板
    var className = __webpack_require__(21);
...
var scss = __webpack_require__(66);
var when = __webpack_require__(35);
var pathManager = __webpack_require__(91);
var frames = __webpack_require__(88);
var dialogManager = __webpack_require__(36);
var leftNav = __webpack_require__(90);
...
var custFuncs = {
	...
	updateView: function () {
		...
		if (moduleList == null) {
			...
			if (newModuleName == moduleName) {
				custFuncs.openPage().otherwise(custFuncs.errorHandler);
				return;
			}
			moduleName = newModuleName;
	...
	getMenuList: function () {
		...
		//通过moduleId获取左边菜单
		//
		var jsonStr = 'arr1.json';

		if (moduleName == 'test2') {
			jsonStr = 'arr2.json';
		}
		ajax({
			'url': 'js/src/pages/frame/json/' + jsonStr,
			'method': 'get',
			'data': null,
	...
	getModuleList: function () {
		var defer = when.defer();
		ajax({
			'url': 'js/src/pages/frame/json/arr.json',
			'method': 'get',
			'data': null,
			'onSuccess': function (res) {
				moduleList = res.data;
	...
	openPage: function () {
		...
		m_leftNav.setData(menuList, path);
		m_header.selectedById(moduleId);
		defer.resolve();
		return defer.promise;
	},
