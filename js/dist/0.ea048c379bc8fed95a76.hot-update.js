...
module.exports = function (node, opts) {
    ...
    var custFuncs = {
        pageChange: function () {
            ...
            nodeList.text.innerHTML = "当前" + (1 + nodeList.pageSize.value * (nodeList.page.value - 1)) + "到" + curNum + "条，总共" + opts.totalRows + "条";

            that.fire("page", { pageSize: nodeList.pageSize.value, curpage: nodeList.page.value });
        },
        initView: function () {
            custFuncs.pageChange();
        },
